import { getScienceFictionMovie } from '@/services/movie.service'
import React from 'react'

const ScienceFictionMovieCpmponent = async() => {
    const movieData = await getScienceFictionMovie();
...
export default ScienceFictionMovieCpmponent